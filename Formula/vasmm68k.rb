class Vasmm68k < Formula
  ...
  test do
    ...
    shell_output(["#{bin}/vasmm68k_mot", "-Fhunk", "-o", testpath/"test_mot.o", testpath/"test_mot.s"].join(" "))
    ...
    shell_output(["#{bin}/vasmm68k_std", "-Fhunk", "-o", testpath/"test_std.o", testpath/"test_std.s"].join(" "))
